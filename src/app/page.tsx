...
const HomePage = () => {
  return (
    <div className="flex flex-col gap-5 px-10 py-10">
      <MoveTypeLabel type="small" size="responsive" />
      <MoveTypeLabel type="home" size="responsive" />
      ...
      <CircleTextLabel text="부산" Clickable={true} size="responsive" />
      <CircleTextLabel text="소형이사" Clickable={true} size="responsive" />
      <CircleTextLabel text="서울" Clickable={true} size="responsive" />
      <CircleTextLabel text="사무실이사" Clickable={true} size="responsive" />
